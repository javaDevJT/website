...
export const engineAscii = (): string => {
  return `
        V8 Twin-Turbo Engine Visualization
        
            [T]         [T]
             |           |
        ╔════╧═══════════╧════╗
        ║  ┌─┐ ┌─┐ ┌─┐ ┌─┐  ║
        ║  │1│ │2│ │3│ │4│  ║ Cylinders 1-4
        ║  └─┘ └─┘ └─┘ └─┘  ║
        ║  ┌─┐ ┌─┐ ┌─┐ ┌─┐  ║
        ║  │5│ │6│ │7│ │8│  ║ Cylinders 5-8
        ║  └─┘ └─┘ └─┘ └─┘  ║
        ╚══════════╤══════════╝
                   │
              Crankshaft
